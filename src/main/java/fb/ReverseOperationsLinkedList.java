...
public class ReverseOperationsLinkedList {
    ...
    Node reverseOdds(Node head) {
        ...
        head.next = curr; // after we reversed even numbers add the rest of the list to the headElement that right now became last one
        return prev;
    }
    ...
    public static void main(String[] args) {
        new ReverseOperationsLinkedList().run();
    }
}
